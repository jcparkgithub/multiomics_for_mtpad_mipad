...
read.table("/home/dell/newinput/tpad1_tgwas_new01c.txt")
tpad1_tgwas <- read.table("/home/dell/newinput/tpad1_tgwas_new01c.txt")
read.table("/home/dell/newinput/tpad2_miRNA_new.txt")
tpad2_miRNA <- read.table("/home/dell/newinput/tpad2_miRNA_new.txt")
read.table("/home/dell/newinput/tpad3_proteomics_new.txt")
tpad3_proteomics <- read.table("/home/dell/newinput/tpad3_proteomics_new.txt")
read.table("/home/dell/newinput/tpad4_blood_biomarkers_new.txt")
tpad4_blood_biomarkers <- read.table("/home/dell/newinput/tpad4_blood_biomarkers_new.txt")

#Load datasets to MOFA+
Multiomic_dataset <- list(tp_tgwas=tpad1_tgwas, tp_miRNA=tpad2_miRNA, tp_proteomics=tpad3_proteomics, 
                          tp_biomarkers=tpad4_blood_biomarkers)
...
#Test
MOFAobject_im@data$tp_proteomics[[1]][1:5,160:170]
MOFAobject_im@imputed_data$tp_proteomics[[1]][["mean"]][1:5,160:170]
get_imputed_data(MOFAobject_im)

#Export the imputed data to xlsx file
library("openxlsx")
imputed_tpad2_miRNA <- MOFAobject_im@imputed_data$tp_miRNA[[1]][["mean"]]
imputed_tpad2_miRNA
write.xlsx(imputed_tpad2_miRNA, sheetName="sheet1", file="imputed_tpad2_miRNA_new.xlsx")
imputed_tpad3_proteomics <- MOFAobject_im@imputed_data$tp_proteomics[[1]][["mean"]]
imputed_tpad3_proteomics
write.xlsx(imputed_tpad3_proteomics, sheetName="sheet1", file="imputed_tpad3_proteomics_new.xlsx")
imputed_tpad4_blood_biomarkers <- MOFAobject_im@imputed_data$tp_biomarkers[[1]][["mean"]]
imputed_tpad4_blood_biomarkers
write.xlsx(imputed_tpad4_blood_biomarkers, sheetName="sheet1", file="imputed_tpad4_blood_biomarkers_new.xlsx")
...
plot_top_weights(MOFAobject_im, view = "tp_tgwas", 
                 factor = 1, nfeatures = 30, scale =T)
plot_top_weights(MOFAobject_im, view = "tp_miRNA", 
                 factor = 1, nfeatures = 10, scale =T)
plot_top_weights(MOFAobject_im, view = "tp_proteomics", 
                 factor = 1, nfeatures = 10, scale =T)
plot_top_weights(MOFAobject_im, view = "tp_biomarkers", 
                 factor = 1, nfeatures = 10, scale =T)
plot_top_weights(MOFAobject_im, view = "tp_tgwas", 
...
get_weights(MOFAobject_im, view = "tp_tgwas", 
            factor = 1, scale =T)
get_weights(MOFAobject_im, view = "tp_miRNA", 
            factor = 1, scale =T)
get_weights(MOFAobject_im, view = "tp_proteomics", 
            factor = 1, scale =T)
get_weights(MOFAobject_im, view = "tp_biomarkers", 
            factor = 1, scale =T)
get_weights(MOFAobject_im, view = "tp_tgwas", 
            factor = 2, scale =T)
get_weights(MOFAobject_im, view = "tp_miRNA", 
